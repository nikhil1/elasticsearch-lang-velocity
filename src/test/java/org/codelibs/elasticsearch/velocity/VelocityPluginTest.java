...
public class VelocityPluginTest {
    ...
    public void test_search() throws Exception {
        ...
        for (int loop = 0; loop < 100; loop++) {
            ...
            query = """
                    {"lang":"mustache","template":{"query":{"match":{"{{my_field}}":"{{my_value}}"}},"size":"{{my_size}}"},\
                    "params":{"my_field":"category","my_value":"1","my_size":"50"}}\
                    """;
            try (CurlResponse curlResponse = EcrCurl.post(node, "/" + index + "/" + type + "/_search/script_template")
                    .header("Content-Type", "application/json").body(query).execute()) {
            ...
            query = """
                    {"lang":"velocity","template":{"query":{"match":{"${my_field}":"${my_value}"}},"size":"${my_size}"},\
                    "params":{"my_field":"category","my_value":"1","my_size":"50"}}\
                    """;
            try (CurlResponse curlResponse = EcrCurl.post(node, "/" + index + "/" + type + "/_search/script_template")
                    .header("Content-Type", "application/json").body(query).execute()) {
            ...
            query = """
                    {"lang":"velocity","template":"#parse(\\"lib_search_query_1.vm\\")",\
                    "params":{"my_field":"category","my_value":"1","my_size":"50"}}\
                    """;
            try (CurlResponse curlResponse = EcrCurl.post(node, "/" + index + "/" + type + "/_search/script_template")
                    .header("Content-Type", "application/json").body(query).execute()) {
            ...
            query = """
                    {"lang":"velocity","id":"index_search_query_1",\
                    "params":{"my_field":"category","my_value":"1","my_size":"50"}}\
                    """;
            try (CurlResponse curlResponse = EcrCurl.post(node, "/" + index + "/" + type + "/_search/script_template")
                    .header("Content-Type", "application/json").body(query).execute()) {
            ...
            query = """
                    {"lang":"velocity","template":"#macroSearchQuery",\
                    "params":{"my_field":"category","my_value":"1","my_size":"50"}}\
                    """;
            try (CurlResponse curlResponse = EcrCurl.post(node, "/" + index + "/" + type + "/_search/script_template")
                    .header("Content-Type", "application/json").body(query).execute()) {
    ...
    public void test_render() throws Exception {
        ...
        query = """
                {"lang":"velocity","inline":"{\\"query\\":{\\"match\\":{\\"$my_field\\":\\"$my_value\\"}},\\"size\\":\\"$my_size\\"}",\
                "params":{"my_field":"category","my_value":"1","my_size":"50"}}\
                """;
        try (CurlResponse curlResponse =
